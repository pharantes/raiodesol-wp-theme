...
?>
<main style="padding: 5rem 0;" class="politica-privacidade">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2>Política de Privacidade</h2>
                <p>A sua privacidade é importante para nós. É política do raiodesol-rio.com respeitar a sua privacidade em
                    relação a qualquer informação sua que possamos coletar no site <a href=https://raiodesol-rio.com>raiodesol-rio.com </a>, e outros sites que possuímos e operamos.</p> <p>Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço.
                ...
                <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza
                    se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos
                    que você usa em nosso site.</p>
